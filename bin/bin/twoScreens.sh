...
# one horizontal, vertical screen
...
# without panning so that second screen does not lose scaling
xrandr --fb 6000x6000 --dpi 183 --output HDMI-2 --primary --mode 3840x2160 --pos 0x0 --rotate normal --output HDMI-1 --off --output DP-1 --off --output HDMI-3 --mode 1920x1080 --pos 3840x0 --scale 2x2 --rotate right
