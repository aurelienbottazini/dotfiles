...
* Org
  #+begin_src emacs-lisp
    (use-package htmlize)
    (add-hook 'org-mode-hook (lambda () (define-key evil-normal-state-map (kbd \T\A\B"") 'org-cycle)))
...
#+BEGIN_SRC emacs-lisp
  (use-package company
    ...
    (use-package ac-js2)
    (setq company-backends '((company-dabbrev company-capf company-css company-elisp ac-js2-company) company-files))
