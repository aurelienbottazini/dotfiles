...
** Windows
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package ace-window
       ...
       :config
       (define-key my-leader-map (kbd "w") 'ace-window))
   #+END_SRC
** avy / ace-jump / easy-motion
   #+BEGIN_SRC emacs-lisp
     (use-package avy
      :config
...
** Javascript
   ...
   #+begin_src emacs-lisp
     ...
     ;; for now it formats wrongly the html attributes
     ;; (add-hook 'web-mode-hook #'(lambda ()
     ;;                              (enable-minor-mode
...
#+BEGIN_SRC emacs-lisp
  (use-package company
    ...
    (use-package ac-js2)
    (setq company-backends '(company-css company-elisp ac-js2-company company-files company-dabbrev))
...
* Bindings
  ...
  #+begin_src emacs-lisp
    ...
    (define-key my-leader-map (kbd "pa") '(lambda () (interactive) (find-file "~/work/activities")))
    (define-key my-leader-map (kbd "pc") '(lambda () (interactive) (find-file "~/work/doximity-client-vue")))
    (define-key my-leader-map (kbd "pd") '(lambda () (interactive) (find-file "~/work/doximity")))
