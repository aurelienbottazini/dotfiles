...
=======
        (use-package evil
          ...
          (evil-ex-define-cmd "W" 'save-buffer)
          (bind-keys :map evil-normal-state-map :prefix-map my-leader-map :prefix "SPC"))
>>>>>>> bf1172c783f7b1199ee7edd79d5f0ef96a015a31
  #+end_src
* Better Defaults
...
=======
                ...
                ("S" . projectile-find-implementation-or-test-other-window)
                :map projectile-mode-map
                ("C-c p" . projectile-command-map))
    :init
    (setq projectile-switch-project-action 'projectile-dired)
...
<<<<<<< HEAD
=======
  (add-to-list 'auto-mode-alist '(".output.yaml\\'" . cfn-mode))
>>>>>>> bf1172c783f7b1199ee7edd79d5f0ef96a015a31
...
When using expand-region, use ~e~ to enter iedit state.
#+begin_src emacs-lisp
