...
* Better Defaults
  ...
  #+begin_src emacs-lisp
    (setenv "PATH" (concat "/Users/aurelienbottazini/.config/yarn/global/node_modules/.bin/:"
                           ...
                           "/home/aurelienbottazini/work/dox-compose/bin/:"
...
* Org
  #+begin_src emacs-lisp
    ...
    (defun draft-org-files ()
      (directory-files-recursively "~/Dropbox/org/drafts/" ".*\.org"))
...
* Bindings
  ...
  #+begin_src emacs-lisp
    ...
    (define-key my-leader-map (kbd "jd") '(lambda () (interactive) (find-file "~/Dropbox/")))
