...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#f1f2f1" :foreground "#000000" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight light :height 111 :width normal :foundry "H&Co" :family "Operator Mono"))))
 ...
 '(font-lock-comment-face ((t (:foreground "#939598" :family "Operator Mono BookItalic"))))
 ...
 '(lsp-ui-sideline-current-symbol ((t (:foreground "#3a499c" :weight bold :height 0.99))))
