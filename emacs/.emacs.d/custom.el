...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 160 :family "JetBrains Mono"))))
 '(bold ((t (:weight bold))))
 '(custom-variable-tag ((t (:foreground "#3a499c" :weight bold))))
 ...
 '(magit-blame-heading ((t (:inherit magit-blame-highlight :slant normal :weight bold))))
 '(magit-diff-file-heading ((t (:weight bold))))
 '(magit-filename ((t (:weight bold))))
