...
(custom-set-faces
 ...
 '(linum ((t (:background "#3F3F3F" :foreground "#6F6F6F"))))
 ...
 '(mode-line-buffer-id ((t (:foreground "#dcdcc" :slant italic :weight bold))))
