...
(custom-set-faces
 ...
 '(org-level-1 ((t (:inherit outline-1 :foreground "#bc3e44" :weight extra-bold :height 1.3 :family "Gotham HTF"))))
 '(org-level-2 ((t (:inherit outline-2 :height 1.0 :family "Gotham HTF" :weight extra-bold))))
 '(org-level-3 ((t (:inherit outline-3 :family "Gotham HTF" :weight extra-bold))))
