...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#fdf6e3" :foreground "#657b83" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :height 111 :width normal :family "PragmataPro Liga"))))
 ...
 '(error ((t (:foreground "#dc322f" :weight normal))))
 '(evil-search-highlight-persist-highlight-face ((t (:background "#b58900"))))
 ...
 '(font-lock-keyword-face ((t (:foreground "#586e75" :weight normal))))
 ...
 '(isearch ((t (:background "#fccf61" :foreground "#586e75"))))
 '(line-number ((t (:background "#eee8d5" :foreground "#939598"))))
 '(line-number-current-line ((t (:background "#eee8d5" :foreground "black"))))
 '(linum ((t (:background "#dad9d6" :foreground "#586e75"))))
 ...
 '(magit-signature-bad ((t (:foreground "#dc322f" :weight normal))))
 ...
 '(mode-line-inactive ((t (:background "#dad9d6" :foreground "#586e75"))))
 ...
 '(org-agenda-structure ((t (:foreground "#268bd2"))))
 ...
 '(org-todo ((t (:foreground "#dc322f" :weight bold))))
 '(outline-2 ((t (:inherit font-lock-variable-name-face :foreground "#3a499c"))))
 '(region ((t (:background "#adcff1"))))
 '(secondary-selection ((t (:background "#b58900"))))
 '(show-paren-match ((t (:background "#97d88a" :foreground "#586e75"))))
 '(show-paren-mismatch ((t (:background "#dc322f"))))
 '(whitespace-indentation ((t (:background "#f79b2f" :foreground "black"))))
 '(whitespace-space-after-tab ((t (:background "#b58900" :foreground "black"))))
 '(whitespace-space-before-tab ((t (:background "#f79b2f" :foreground "black"))))
 '(whitespace-tab ((t (:background "#dc322f" :foreground "black")))))
