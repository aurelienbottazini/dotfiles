...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#fdf6e3" :foreground "#657b83" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight semi-light :height 111 :width normal :foundry "H&Co" :family "Operator Mono"))))
 ...
 '(line-number ((t (:background "#eee8d5" :foreground "#657b83"))))
 '(line-number-current-line ((t (:background "#eee8d5" :foreground "#d33682"))))
 '(linum ((t (:background "#eee8d5" :foreground "#657b83"))))
 ...
 '(mode-line-inactive ((t (:background "#eee8d5" :foreground "#657b83"))))
 ...
 '(org-level-1 ((t (:inherit outline-1 :foreground "#dc322f" :slant italic :weight normal :height 1.3))))
 '(org-level-2 ((t (:inherit outline-2 :foreground "#268bd2" :slant italic :weight normal :height 1.0))))
 '(org-level-3 ((t (:inherit outline-3 :foreground "#859900" :slant italic :weight normal))))
