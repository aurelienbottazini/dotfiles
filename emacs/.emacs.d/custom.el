...
(custom-set-faces
 ...
 '(linum ((t (:inherit (shadow default) :background "#d0d0d0" :width normal))))
 ...
 '(mode-line-inactive ((t (:inherit mode-line :background "#d0d0d0" :foreground "#2b2b2b" :box (:line-width 2 :color "#e4e4e4") :weight light))))
