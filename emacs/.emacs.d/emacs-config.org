...
** Company
   #+begin_src emacs-lisp
     (use-package company
       ...
       (add-hook 'css-mode-hook
                 (lambda ()
                   (set (make-local-variable 'company-backends) '(company-css company-dabbrev-code company-files company-gtags))))

       (add-hook 'js2-mode-hook
                 (lambda ()
                   (set (make-local-variable 'company-backends) '(company-dabbrev-code company-files company-gtags))))
       (add-hook 'web-mode-hook
                 (lambda ()
                   (set (make-local-variable 'company-backends) '(company-web-html company-dabbrev-code company-files company-gtags))))
