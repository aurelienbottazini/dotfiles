...
** Vim Leader
   #+begin_src emacs-lisp
    ...
    (evil-leader/set-key "gs" 'magit-status)
     ...
     (evil-leader/set-key "j" 'evil-avy-goto-char-timer)
...
** Company
   #+begin_src emacs-lisp
     (use-package company
       ...
       (add-hook 'web-mode-hook
                 (lambda ()
                   (set (make-local-variable 'company-backends) '(company-tern company-web-html company-dabbrev-code company-files))))

       (add-hook 'html-mode-hook
                 (lambda ()
                   (set (make-local-variable 'company-backends) '(company-web-html company-dabbrev-code company-files))))
       )
