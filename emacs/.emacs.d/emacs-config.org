...
#+RESULTS:
| (lambda (&rest --cl-rest--) (apply (quote (lambda (G56402) (let ((color (cond ((minibufferp) (symbol-value G56402)) ((evil-insert-state-p) (quote (#e80000 . #ffffff))) ((evil-emacs-state-p) (quote (#444488 . #ffffff))) ((buffer-modified-p) (quote (#006fa0 . #ffffff))) (t (symbol-value G56402))))) (set-face-background (quote mode-line) (car color)) (set-face-foreground (quote mode-line) (cdr color))))) (quote --default-color--) --cl-rest--)) | winner-save-old-configurations | (lambda (&rest --cl-rest--) (apply (quote (lambda (G56401) (let ((color (cond ((minibufferp) (symbol-value G56401)) ((evil-insert-state-p) (quote (#e80000 . #ffffff))) ((evil-emacs-state-p) (quote (#444488 . #ffffff))) ((buffer-modified-p) (quote (#006fa0 . #ffffff))) (t (symbol-value G56401))))) (set-face-background (quote mode-line) (car color)) (set-face-foreground (quote mode-line) (cdr color))))) (quote --default-color--) --cl-rest--)) | sml/generate-position-help | evil-repeat-post-hook |
