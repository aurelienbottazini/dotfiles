...
#+RESULTS:
: /Users/aurelienbottazini/dotfiles/bin/:/usr/local/var/rbenv/shims:/Users/aurelienbottazini/dotfiles/bin/:/usr/local/var/rbenv/shims:/Users/aurelienbottazini/dotfiles/bin/:/usr/local/var/rbenv/shims:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin:/Library/TeX/texbin:
...
* Fonts
  ...
  #+RESULTS:
  | (lambda (frame) (progn (set-face-attribute (quote default) nil :font PragmataPro-14) (set-frame-font PragmataPro-14))) | --set-emoji-font | evil-init-esc | (lambda (frame) (progn (set-frame-font PragmataPro-14))) | select-frame |
...
#+RESULTS:
| flyspell-prog-mode | (lambda nil (turn-on-auto-fill)) | rainbow-delimiters-mode | rainbow-identifiers-mode | turn-on-fci-mode | rainbow-mode |
