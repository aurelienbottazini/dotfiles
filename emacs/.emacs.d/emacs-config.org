...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'post-command-hook
            (lambda ()
              (let ((color (cond ((minibufferp) '("#ffe863" . "#212822"))
                                 ((evil-insert-state-p) '("#da0039" . "#f1f2f1"))
                                 ((evil-visual-state-p) '("#23249e" . "#f1f2f1"))
                                 ((evil-emacs-state-p)  '("#444488" . "#f1f2f1"))
                                 ((buffer-modified-p)   '("#dc4388" . "#f1f2f1"))
                                 (t '("#ffe863" . "#212822")))))
...
#+RESULTS:
| (lambda nil (let ((color (cond ((minibufferp) (quote (#ffe863 . #212822))) ((evil-insert-state-p) (quote (#da0039 . #f1f2f1))) ((evil-visual-state-p) (quote (#23249e . #f1f2f1))) ((evil-emacs-state-p) (quote (#444488 . #f1f2f1))) ((buffer-modified-p) (quote (#dc4388 . #f1f2f1))) (t (quote (#ffe863 . #212822)))))) (set-face-background (quote mode-line) (car color)) (set-face-foreground (quote mode-line) (cdr color)))) | winner-save-old-configurations | sml/generate-position-help | evil-repeat-post-hook |
