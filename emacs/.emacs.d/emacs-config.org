...
* Fonts
  #+BEGIN_SRC emacs-lisp
    ...
    ;;   "adjusts frame font"
    ;;   (set-frame-font "-*-Operator Mono-light-normal-normal-*-14-*-*-*-m-0-iso10646-1")
    ;;   )

    ;; (add-hook 'after-make-frame-functions '--set-frame-font)
  #+END_SRC
...
** Bindings
   #+BEGIN_SRC emacs-lisp
     ...
     ;; problems with hooks and magit. Lost trust in magit...
     ...
     version 2016-06-18"
       ...
       (if (string-equal "*" (substring (buffer-name) 0 1))
         ...
         (if (string-equal major-mode "dired-mode")
             nil
           (if (strin-equal major-mode "magit-mode")
               nil
             t
             ))))
