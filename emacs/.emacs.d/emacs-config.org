...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list 'default-frame-alist
           ...
           '(font . "-*-PragmataPro-normal-normal-*-16-*-*-*-m-0-iso10646-1")
)
#+END_SRC
...
#+begin_src emacs-lisp
  (define-key evil-normal-state-map (kbd "C-p") 'counsel-projectile-find-file)
    ...
    (define-key evil-normal-state-map (kbd "[w") 'persp-previous)
    (define-key evil-normal-state-map (kbd "]w") 'persp-next)
...
** Vim Leader
   #+begin_src emacs-lisp
     ...
     (evil-leader/set-key "ow" 'persp-switch)
...
#+begin_src emacs-lisp
  (ac-define-source ramda-abo
    '((candidates . (list
      ...
      (prefix . "R\.\\(.*\\)")))
  (setq-default ac-sources (push 'ac-source-ramda-abo ac-sources))
