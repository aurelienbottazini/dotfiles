...
** Bindings
   #+BEGIN_SRC emacs-lisp
    ...
    (evil-leader/set-key "gs" 'magit-status)
     ...
     (use-package origami)
     (global-origami-mode)
     (define-key evil-normal-state-map (kbd "[a") 'origami-close-all-nodes)
     (define-key evil-normal-state-map (kbd "]a") 'origami-open-all-nodes)
     ...
     (define-key evil-normal-state-map (kbd "[h") 'origami-close-node)
     (define-key evil-normal-state-map (kbd "]h") 'origami-open-node)
...
* Mode-line / Powerline / Smart line
  #+BEGIN_SRC emacs-lisp
    ...
    (setq rm-blacklist (quote(" company" " FlyC-" " yas" " my-keys" " s-/" " Undo-Tree" " WK" " ARev" " Abbrev" " Fill"))))
  #+END_SRC
