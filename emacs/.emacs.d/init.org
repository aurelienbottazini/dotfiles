...
*** Ansi colors derived from emacs list colors display

| color          | name         | Hex     |
| red            | firebrick    | #b22222 |
| brightred      | red          | #ff0000 |
| blue           | blue1        | #0000ff |
| bright blue    | dark blue    | #00008b |
| yellow         | yellow       | #ffff00 |
| bright yellow  | gold         | #ffd700 |
| green          | forest green | #228b22 |
| dark green     | dark green   | #006400 |
| cyan           | dark cyan    | #008b8b |
| bright cyan    | cyan         | #00ffff |
| magenta        | purple       | #a020f0 |
| bright magenta | magenta      | #ff00ff |
| bright white   | dark gray    | #a9a9a9 |
| bright black   | dim gray     | #696969 |
...
(use-package engine-mode
  :bind (:map my-keys-minor-mode-map
         ("C-c s c" . engine/search-caniuse)
         ("C-c s m" . engine/search-mdn)
         ("C-c s ra" . engine/search-rails)
         ("C-c s rr" . engine/search-ruby))
  :config
