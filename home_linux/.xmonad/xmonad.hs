...
scratchpads =
    ...
    ,(NS "tdd-org-capture"  "emacsclient -ca \"\" --frame-parameters='(quote (name . \"tdd-org-capture\"))' -e '(org-capture nil \"t\")'" (appName =? "tdd-org-capture") (customFloating $ W.RationalRect (1/5) (1/5) (3/5) (3/5)))
...
myKeysP = [
        ...
        , ("M4-<Space> l", spawn "gnome-screensaver-command -l")
