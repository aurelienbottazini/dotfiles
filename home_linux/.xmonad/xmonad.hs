...
myKeysP = [
        ...
        , ("M4--", spawn "pulseaudio-rofi.sh --volume_down")
        ...
        , ("M4-m h",  windowSwap L True)
        , ("M4-m j",  windowSwap D True)
        , ("M4-m k",  windowSwap U True)
        , ("M4-m l",  windowSwap R True)
        ...
        , ("M4-t l", spawn "gnome-screensaver-command -l")
