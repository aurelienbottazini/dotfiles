...
scratchpads =
    ...
    ,(NS "music-player" "jumpapp -c music-player launch-music-player.sh" (className =? "music-player") (customFloating $ W.RationalRect (1/5) (1/5) (3/5) (3/5)))
...
myKeysP = [
        ...
        , ("M4-s m", namedScratchpadAction scratchpads "music-player")
